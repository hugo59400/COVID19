...
$req = $DB->query('Select * from personnel where pe_mail = :mail and pe_password = :password', array('mail' => $Mail, 'password' => crypt($Password, 'lolTuMoraPa')));
$req = $req->fetch();
